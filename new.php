...
if(isset($_POST['submit']) && $_POST['submit'] == 'Update') {
	...
	if (isset($_POST['username'])) $email = stripslashes(strip_tags($_POST['username']));
...
<div class="tooltip">
	<span xclass="tooltiptext"><i class="fa fa-info-circle"></i> Strong password: 8 characters long, with one lower and uppercase, number and special character</span>
</div>
...
<form id="theForm" method="post" action="new.php">
	...
	<input type="text" id="email"  autofocus name="username"  placeholder="Username" value="<?php echo $email?>" />
